...
def main():
    ...
    if args.set_name == "dev_diff_size":
        output_file_path = os.path.join("processed_data", args.dataset_name, f"nf_dev_{len(instances)}_subsampled.jsonl")
        write_jsonl(instances, output_file_path)
    else:
        output_file_path = os.path.join("processed_data", args.dataset_name, f"nf_{args.set_name}_{len(instances)}_subsampled.jsonl")
        write_jsonl(instances, output_file_path)
