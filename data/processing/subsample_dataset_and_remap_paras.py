...
def main():
    ...
    # if args.set_name == "test":
    #     if os.path.exists(os.path.join("processed_data", args.dataset_name, "test.jsonl")):
    #         input_file_path = os.path.join("processed_data", args.dataset_name, "test.jsonl")
    ...
    for instance in tqdm(instances):
        for context in instance["contexts"]:
            ...
            if args.dataset_name in ["hotpotqa", "2wikimultihopqa", "musique", 'nq', 'trivia', 'squad']:
